...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'testnhipster';
    ...
    'jhipster.mail.from' = 'testnhipster@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'testnhipster API';
    'jhipster.swagger.description' = 'testnhipster API documentation';
    ...
    'eureka.instance.appname' = 'testnhipster';
    'eureka.instance.instanceId' = 'testnhipster:${random.value}';
    ...
    'cloud.config.name' = 'testnhipster';
